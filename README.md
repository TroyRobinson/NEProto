...
- **Chat configuration** lets you pick the ACS dataset year, dataset type, and target ZCTAs from dropdowns above the chat box. Updates apply immediately to variable searches and metric retrieval.
