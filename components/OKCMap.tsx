...
export default function OKCMap({ organizations, onOrganizationClick, zctaFeatures, activeOrgId, hoveredOrgId }: OKCMapProps) {
  ...
  const layers = useMemo(() => {
    const layers: any[] = [
      createOrganizationLayer(organizations, onOrganizationClick, activeOrgId, hoveredOrgId)
    ];
    ...
    return layers;
  }, [organizations, onOrganizationClick, zctaFeatures, activeOrgId, hoveredOrgId]);
